...
from .views import home, sign_up, log_out, about, DeleteAccountView, EditProfileView, create_post, my_posts, \
    post_detail, edit_post, delete_post, archive_post, my_archive, unarchive_post, view_statistics
